...
export const goldHint: InfoContent = {
  ...
  entries: [
    ...
    { icon: '💰', label: 'Income', text: 'Your income is the gold you earn at the end of each fight. It grows automatically by 1 after every fight. Stealing items costs income and can push it into the red — while it is, you earn 0.' },
    { icon: '🍀', label: 'Lucky Find', text: 'Chance for each shop item to roll up a rarity (can chain into higher rarities). Every time you buy or upgrade an item to Mythic, permanently gain +2% Lucky Find chance for the rest of the run.' },
  ],
};
...
export const jokerPickHint: InfoContent = {
