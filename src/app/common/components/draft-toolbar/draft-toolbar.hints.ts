...
export const goldHint: InfoContent = {
  ...
  entries: [
    ...
    { icon: '🍀', label: 'Lucky Find', text: 'Chance for each shop item to roll up a rarity (can chain into higher rarities). Every time you buy or upgrade an item to Mythic, permanently gain +3% Lucky Find chance for the rest of the run.' },
  ],
};
