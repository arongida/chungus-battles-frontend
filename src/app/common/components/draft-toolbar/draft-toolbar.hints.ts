...
export const goldHint: InfoContent = {
  ...
  entries: [
    ...
    { icon: '🍀', label: 'Lucky Find', text: 'Chance for each shop item to roll up a rarity. Every time you buy or upgrade an item to Mythic, permanently gain +2% Lucky Find chance.' },
  ],
};
