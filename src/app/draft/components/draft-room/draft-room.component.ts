...
function coercePlayer(src: any): Player {
  ...
  const plainFields: (keyof Player)[] = ['lives', 'playerId', 'originalPlayerId', 'xp', 'maxXp', 'round', 'wins', 'maxHp', 'income', 'hpRegen', 'cooldownReduction', 'dodgeRate', 'refreshShopCost', 'gameVersion', 'comradeFreeClaim', 'goldGenieFreeClaim', 'luckyFindFreeClaim', 'misconductFreeClaim'];
