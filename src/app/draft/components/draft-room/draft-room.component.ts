...
function coercePlayer(src: any): Player {
  ...
  const plainFields: (keyof Player)[] = ['lives', 'playerId', 'originalPlayerId', 'xp', 'maxXp', 'round', 'wins', 'maxHp', 'income', 'hpRegen', 'dodgeRate', 'refreshShopCost', 'gameVersion', 'comradeFreeClaim', 'goldGenieFreeClaim', 'luckyFindFreeClaim'];
